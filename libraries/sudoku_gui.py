...
class sudoku_gui:
    def __init__(self):
        ...
        self.read_puzzle_input = Button(self.c1, text="input your own puzzle", height=round(2*self.scale), width = round(22*self.scale), bg='white', command=self.input_puzzle)
        self.read_random_button = Button(self.c1, text="read a random puzzle from file", anchor="center", height = round(2*self.scale), width = round(22*self.scale), bg = "white", command=self.read_random_puzzle)
        self.gen_random_button = Button(self.c1, text="generate a random puzzle", anchor="center", height = round(2*self.scale), width = round(22*self.scale), bg = "white", command=self.generate_puzzle)
        self.computer_solve_button = Button(self.c1, text="Solve With Computer", anchor="center", height = round(2*self.scale), width = round(15*self.scale), bg = "white", command=self.computer_solve)
